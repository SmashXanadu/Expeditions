...
The two main rolls of the game-the ability check and the attack roll-rely on the six ability scores. The book's introduction describes the basic rule behind these rolls: roll a d20, add an ability modifier, and compare the total to a target number.

## Ability Modifiers

Each of a creature's abilities has a modifier, a number that defines the magnitude of that ability. An ability modifier is not just a measure of innate capabilities, but also encompasses a creature's training and competence in activities related to that ability.

A modifier of +0 is the normal human average, but adventurers and many monsters are a cut above average in most abilities. Depending on the character's ability this modifier may be as low as -5 or as high as +10.
