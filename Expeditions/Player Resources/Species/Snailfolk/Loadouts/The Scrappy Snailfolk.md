---
layout: default
permalink: /PlayerResources/Species/Snailfolk/Loadouts/TheScrappySnailfolk/
---
...
| Legs      |                       |                                                |
| Feet      |                       |                                                |
| Accessory | Cracked Nautilite Eye | Grants sight in darkness; glows near hidden spaces. |
...
| Item                 | Description                                       |
| -------------------- | ------------------------------------------------- |
| Eel Slick            | Thick eel oil for traps, slides, or sabotage.     |
| Coral-Tied Lodestone | Powerful magnet on braided coral for retrieving metal. |
| Barnacled Pot        | Battered cauldron that doubles as a helmet.       |
| Wrecking Spike       | Forces open doors, crates, and sealed hulls.      |
|                      |                                                   |
|                      |                                                   |
|                      |                                                   |
|                      |                                                   |
