---
layout: default
permalink: /PocketEdition/LoadoutCards/
---
...
- **Bitter Tonic.** A thick, bitter liquid that dulls the body’s sense of pain.
...
- **Fine Silk Rope.** A dark cord with a collapsible grappling hook.
...
- **Lead-Lined Reliquary Box.** A reinforced container designed to safely store unstable magical objects.
...
- **Volcanic Flint.** A rare self-striking firestone that sparks even in heavy rain.
...
- **Signal Mirror.** A polished glass used for flashes or checking corners.
...
- **String Magnet.** A powerful lodestone tied to colorful yarn for retrieving metal objects.
