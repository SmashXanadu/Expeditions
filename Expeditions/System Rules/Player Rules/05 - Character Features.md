...
- Each ability can be used to perform **Basic Actions** that are free to use, or **Charged Actions** that cost a **Charge**.
- Tell your **Guide** what you want to do with your ability — they will decide if it is basic (free) or if it requires a charge. Spending a charge succeeds automatically without a roll.
- If you have no charges left, you cannot use charged actions.
...
[Previous]({{site.baseurl}}/Rules/4/#downtime) | **[Next: Character Creation]({{site.baseurl}}/Rules/6/)** | [Rules]({{site.baseurl}}/Rules/Index/#rules)
