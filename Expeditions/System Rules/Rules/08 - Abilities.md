...
- **[Precision]({{site.baseurl}}/PlayerResources/Abilities/Precision/)**:  Exploit the weakest point in any defense with surgical accuracy.
- **[Moon]({{site.baseurl}}/PlayerResources/Abilities/Moon/)**:  Heal spirits, shroud the land, or unleash primal ferocity with lunar power.
- **[Blood]({{site.baseurl}}/PlayerResources/Abilities/Blood/)**:  Control the flow of life to drain enemies and restore allies.
- **[Star]({{site.baseurl}}/PlayerResources/Abilities/Star/)**:  Obliterate targets and empower allies with cosmic fragments and astral energy.
- **[Volcanic]({{site.baseurl}}/PlayerResources/Abilities/Volcanic/)**:  Release magma, ash, and scorching heat that reshapes terrain.
- **[Decay]({{site.baseurl}}/PlayerResources/Abilities/Decay/)**:  Spread blight and fumes to dissolve obstacles and leave enemies brittle.
- **[Sun]({{site.baseurl}}/PlayerResources/Abilities/Sun/)**:  Sear corruption, blind enemies, and empower strikes with solar fire.
- **[Undead]({{site.baseurl}}/PlayerResources/Abilities/Undead/)**:  Command the fallen and tap deathly resilience to persist past your limits.
- **[Radiance]({{site.baseurl}}/PlayerResources/Abilities/Radiance/)**:  Blind enemies and embolden allies with floods of holy brilliance.
- **[Renewal]({{site.baseurl}}/PlayerResources/Abilities/Renewal/)**:  Mend wounds, purge poison, and restore the will to fight.
- **[Growth]({{site.baseurl}}/PlayerResources/Abilities/Growth/)**:  Grow vines and thickets to entangle enemies and reshape the battlefield.
...
[Previous]({{site.baseurl}}/Rules/10/#trade-skills) | **[Next: Character Idea Tables]({{site.baseurl}}/Rules/12/)** | [Rules]({{site.baseurl}}/Rules/Index/#rules)
