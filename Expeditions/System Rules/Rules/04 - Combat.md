...
---
# [Combat](#combat)
When conflict breaks out, the **Guide** will shift the game into **Combat** mode. Combat is organized into rounds, where the **Players** and the **Adversaries** take turns performing actions.
...
- Use an **Ability** or **Attack**
- **Move** to a new location
- **Speak** or **Interact** with something

### [Using Abilities](#use-an-ability)
When using an **Ability**, describe what you're trying to do with your ability. Your Guide will let you know if you must spend a charge.  Spending a charge guarantees success.
...
3. Roll your D20 and add any bonuses from relevant skills or abilities. If your total meets or beats the target number, your attack hits!
4. If you hit, you deal 1 **Damage**, (or 2 damage on a critical hit) and any other effects happen.

### [Movement and Range](#zoned-combat)
Combat takes place in **Zones**, which are abstractly defined general areas on a map or table. When you **Move** on your turn, you move to an **adjacent zone**. 

The **Range** to your target(s) will fall into one of these categories:
...
In general: Melee weapons can be used to attack adversaries at Close range. Ranged weapons can be used to attack adversaries at Near range. 
...
When you take damage, you reduce your current **Health** by the amount of incoming damage. If your **Health** drops to 0, you fall **Unconscious**.
