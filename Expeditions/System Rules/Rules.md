...
### Feature Sets
	...
	**No Exotic Features**: Gain any starting Node

	**Aquatic**: Gain Water Node, Underwater Breathing
	Features: Gills, Fins, Deep-Sea Eyes, Shimmering Skin

	**Bestial**: Gain Animals or Shifting Node
	+1 Dmg to Unarmed Attacks
	Features: Fangs, Fur, Horns, Hooves, Scales
	
	**Avian**: Gain Flight or Air Node
	Features: Feathers, Beak, Talons, Wings

	**Angelic/Demonic**: Gain Light, or Dark Node
